...
![MindOrbit](./public/mindorbit_ss3.png)
![MindOrbit](./public/mindorbit_ss4.png)
_MindOrbit running on Apple Vision Pro Simulator_

## Features

### Spatial Workspace

- Arrange floating panels for notes, music, and todo list in a 3D space.
...
- A distraction-free floating todo list for effortless task tracking.
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/aungbbo/MindOrbit.git
   cd "MindOrbit
   ```
...
[Devpost](https://devpost.com/software/abc-4ogw9r)
